#!/usr/bin/env python3
"""Test the updated RSI-MA implementation with EMA(7) pre-smoothing of z-scores."""
...
def calculate_rsi_ma_with_ema7_smoothing(ticker):
    """
    ...
    # Step 4: Apply RSI to smoothed z-scores (Wilder's method)
    rsi_length = 14
...
print("="*80)
print("TESTING UPDATED RSI-MA IMPLEMENTATION WITH EMA(7) PRE-SMOOTHING")
print("="*80)
print("Pipeline:")
...
for ticker in tickers:
    ...
    try:
        result = calculate_rsi_ma_with_ema7_smoothing(ticker)
