...
STOCK_METADATA = {
    ...
    "CNX1": StockMetadata(
        ticker="CNX1",
        name="CNX1 (LSE)",
        personality="UK Equity",
        reliability_4h="Medium",
        reliability_daily="Medium",
        tradeable_4h_zones=['0-5', '5-15', '15-25', '25-50'],
        dead_zones_4h=['75-85', '85-95', '95-100'],
        best_4h_bin="5-15",
        best_4h_t_score=0.0,
        ease_rating=5,
        is_mean_reverter=True,
        is_momentum=False,
        volatility_level="Medium",
        entry_guidance="Treat as an LSE equity; favor 0-15% percentile pullbacks for entries.",
        avoid_guidance="Avoid chasing above 85% until the setup resets.",
        special_notes="Yahoo Finance symbol CNX1.L (London Stock Exchange)."
    ),
    "CSP1": StockMetadata(
        ticker="CSP1",
        name="CSP1 (LSE)",
        personality="UK S&P 500 Tracker",
        reliability_4h="Medium",
        reliability_daily="Medium",
        tradeable_4h_zones=['0-5', '5-15', '15-25', '25-50'],
        dead_zones_4h=['75-85', '85-95', '95-100'],
        ...
        is_momentum=False,
        volatility_level="Medium",
        entry_guidance="S&P 500 tracker on LSE; favor 0-15% percentile pullbacks for entries.",
        avoid_guidance="Avoid chasing above 85% until the setup resets.",
        special_notes="Yahoo Finance symbol CSP1.L (London Stock Exchange). Tracks S&P 500."
    ),
    "BTCUSD": StockMetadata(
        ticker="BTCUSD",
        name="Bitcoin USD",
        personality="Crypto - High Volatility Momentum",
        reliability_4h="⭐⭐⭐ Good",
        reliability_daily="⭐⭐⭐ Good",
        tradeable_4h_zones=['0-5', '5-15', '85-95', '95-100'],
        dead_zones_4h=['30-70'],
        best_4h_bin="0-5",
        best_4h_t_score=0.0,
        ease_rating=3,
        ...
        is_momentum=True,
        volatility_level="High",
        entry_guidance="Momentum plays at extremes. Buy extreme dips (0-15%) or ride breakouts (85-100%).",
        avoid_guidance="Avoid mid-range (30-70%) - choppy price action with no edge.",
        special_notes="24/7 trading. High volatility. Momentum-driven. Yahoo symbol BTC-USD."
    ),
    "ES1": StockMetadata(
        ticker="ES1",
        name="E-mini S&P 500 Futures",
        personality="S&P 500 Futures - Mean Reverter",
        reliability_4h="⭐⭐⭐⭐ Very Good",
        reliability_daily="⭐⭐⭐⭐⭐ Excellent",
        tradeable_4h_zones=['0-5', '5-15', '15-25', '25-50'],
        dead_zones_4h=['75-85', '85-95', '95-100'],
        ...
        is_momentum=False,
        volatility_level="Medium",
        entry_guidance="Buy dips at ≤15% percentile. Futures track SPY closely with leverage. Good for mean reversion.",
        avoid_guidance="Avoid entering above 75% - mean reversion weakens at highs.",
        special_notes="E-mini S&P 500 futures (ES=F). Nearly 24/5 trading. High liquidity. Tracks SPY."
    ),
    "NQ1": StockMetadata(
        ticker="NQ1",
        name="E-mini Nasdaq 100 Futures",
        personality="Nasdaq 100 Futures - Tech Momentum",
        reliability_4h="⭐⭐⭐⭐ Very Good",
        reliability_daily="⭐⭐⭐⭐⭐ Excellent",
        tradeable_4h_zones=['0-5', '5-15', '15-25', '25-50', '50-75'],
        dead_zones_4h=['85-95', '95-100'],
        best_4h_bin="0-5",
        best_4h_t_score=3.1,
        ease_rating=5,
        is_mean_reverter=True,
        is_momentum=True,
        volatility_level="Medium-High",
        entry_guidance="Buy dips at ≤15% percentile. More volatile than ES. Can ride momentum above 50%.",
        avoid_guidance="Avoid entering above 85% without strong momentum confirmation.",
        special_notes="E-mini Nasdaq 100 futures (NQ=F). Nearly 24/5 trading. Tech-heavy, higher beta than ES."
    ),
    "VIX": StockMetadata(
        ticker="VIX",
        name="CBOE Volatility Index",
        personality="Fear Gauge - Mean Reverting",
        reliability_4h="⭐⭐⭐⭐ Very Good",
        reliability_daily="⭐⭐⭐⭐⭐ Excellent",
        ...
        is_momentum=False,
        volatility_level="High",
        entry_guidance="Sell volatility at extreme highs (≥85% percentile) for mean reversion. Buy volatility at extreme lows (≤15%) before market events.",
        avoid_guidance="Avoid trading mid-range (25-75%) - wait for extremes",
        special_notes="VIX measures market fear. Spikes to extreme highs then reverts. Counter-cyclical to equity markets. Best traded at statistical extremes."
    ),
    "IGLS": StockMetadata(
        ticker="IGLS",
        name="IGLS (London)",
        personality="London Market Equity",
        reliability_4h="⭐⭐⭐ Good",
        reliability_daily="⭐⭐⭐⭐ Very Good",
        tradeable_4h_zones=['0-5', '5-15', '15-25', '25-50'],
        dead_zones_4h=['75-85', '85-95', '95-100'],
